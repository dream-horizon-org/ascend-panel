import { Box, Typography, Table, TableBody, TableCell, TableHead, TableRow, Paper, useTheme } from "@mui/material";
                                ...
                                <ResponsiveContainer width="100%" height={300}>
                                    <LineChart data={chartData}>
                                        ...
                                        <XAxis
                                            ...
                                            label={{ value: "Time", position: "insideBottom", offset: -5, style: { fontFamily: "Inter", fontSize: "0.75rem", fill: theme.palette.text.secondary } }}
                                            style={{ fontFamily: "Inter", fontSize: "0.75rem" }}
                                        />
                                        <YAxis
                                            stroke={theme.palette.text.secondary}
                                            label={{ value: "Users", angle: -90, position: "insideLeft", style: { fontFamily: "Inter", fontSize: "0.75rem", fill: theme.palette.text.secondary } }}
                                            style={{ fontFamily: "Inter", fontSize: "0.75rem" }}
                                            domain={[0, 160000]}
                                            tickFormatter={(value) => {
                                                if (value >= 1000) {
