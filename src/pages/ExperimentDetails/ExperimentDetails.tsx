...
const mapStatus = (status: string): { label: string; color: "active" | "inactive" | "draft" } => {
    const statusMap: Record<string, { label: string; color: "active" | "inactive" | "draft" }> = {
